...
class TankerListGarage extends StatefulWidget {
  const TankerListGarage({
    Key? key,
    required this.list,
  ...
  @override
  State<TankerListGarage> createState() => _TankerListGarageState();
}

class _TankerListGarageState extends State<TankerListGarage> {
  ...
  Future<void> bookTanker(int index) async {
    ...
    final result = await Garageservices.OrderGarage(
      widget.projectname,
      widget.capacity,
      widget.stp,
      widget.distance,
    ...
    if (result['error'] == false) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => const ReceiptGarage()),
      );
