...
class DashboardWardOfficer extends StatefulWidget {
  const DashboardWardOfficer({super.key});

  @override
  State<DashboardWardOfficer> createState() => _DashboardWardOfficerState();
}

class _DashboardWardOfficerState extends State<DashboardWardOfficer> {
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const ReceiptWardoff()));
                      },
                      child: Container(
                        decoration: BoxDecoration(
                          color: Colors.green[50],
