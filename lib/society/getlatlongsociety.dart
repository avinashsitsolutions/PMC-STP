...
class Societylatlong extends StatefulWidget {
  const Societylatlong({
    super.key,
  });
  @override
  State<Societylatlong> createState() => _SocietylatlongState();
}

class _SocietylatlongState extends State<Societylatlong> {
