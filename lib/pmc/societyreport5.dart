...
class Societyreport5 extends StatefulWidget {
  const Societyreport5(
      {super.key,
      required this.date1,
      required this.date2,
      required this.stpname,
      required this.id});
  final String date1;
  final String date2;
  ...
  final String id;
  @override
  State<Societyreport5> createState() => _Societyreport5State();
}

class _Societyreport5State extends State<Societyreport5> {
  ...
  void initState() {
    ...
    PCMCservices.reportsociety2(widget.date1, widget.date2, widget.id)
        .then((data) {
      if (data['error'] == true) {
        check = "false";
        setState(() {
          _dataList = data['data'];
          complatedorders = data['Total orders'];
          complatedliters = data['Total liters'];
        });
        setState(() {
          isLoading = false;
        });
