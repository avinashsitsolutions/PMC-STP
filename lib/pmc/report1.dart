...
class _Report1State extends State<Report1> {
  ...
  void initState() {
    super.initState();
    PCMCservices.report(widget.date1, widget.date2, widget.dropdownValue)
        .then((data) {
      if (data['error'] == true) {
        check = "false";
        ...
        setState(() {
          ...
          total_litters = data['totalWaterCapacity'].toString();
          isLoading = false;
        });
      }
    });
                      ...
                      Expanded(
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              // DateTime date1 = DateTime.parse(widget.date1);
                              // DateTime date2 = DateTime.parse(widget.date2);
