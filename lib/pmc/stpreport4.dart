...
class Stpreport4 extends StatefulWidget {
  const Stpreport4(
      {super.key,
      required this.date1,
      required this.date2,
  ...
  final String id;
  @override
  State<Stpreport4> createState() => _Stpreport4State();
}

class _Stpreport4State extends State<Stpreport4> {
  ...
  void initState() {
    ...
    PCMCservices.reportstp4(widget.date1, widget.date2, widget.id).then((data) {
      if (data['error'] == true) {
        check = "false";
        setState(() {
          _dataList = data['data'];
