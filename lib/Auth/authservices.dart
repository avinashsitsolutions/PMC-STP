...
class Authservices {
  static registerUser(
    ...
    final response = await http.post(
      Uri.parse('${Config.baseUrl}/register_new'),
      body: {
  ...
  static loginUser(
    ...
    final response = await http.post(
      Uri.parse("${Config.baseUrl}/login_new"),
      headers: {
  ...
  static loginWardOfficer(
    ...
    setLoading(true);
    final response = await http.post(
      Uri.parse("${Config.baseUrl}/PMC_login"),
      body: {
        'ni_employee_id': id,
        'password': password,
      },
  ...
  static forgetpassword(
    ...
    final response = await http.post(
      Uri.parse("${Config.baseUrl}/updatePassword_tanker_owner"),
      body: {
  ...
  static forgetpassword1(
    ...
    final response = await http.post(
      Uri.parse("${Config.baseUrl}/users/password/tanker"),
      body: {
  ...
  static forgetpassword2(
    ...
    final response = await http.post(
      Uri.parse("${Config.baseUrl}/updatePassword_bcp"),
      body: {
        'ni_bcp_no': tankerno,
        'password': password,
        'password_confirmation': newpassword,
  ...
  static loginstp(
    ...
    // print(token1);
    final response = await http.post(
      Uri.parse("${Config.baseUrl}/stp_login"),
      headers: {
        'Authorization': 'Bearer $token',
        'Accept': 'application/json',
        'Content-Type': 'application/x-www-form-urlencoded',
  ...
  static logintanker(
    ...
    // print(token);
    final response = await http.post(
      Uri.parse("${Config.baseUrl}/tanker_login"),
      headers: {
        'Authorization': 'Bearer $token',
        'Accept': 'application/json',
        'Content-Type': 'application/x-www-form-urlencoded',
  ...
  static loginmanager(
    ...
    // print(token);
    final response = await http.post(
      Uri.parse("${Config.baseUrl}/site_manager_login"),
      body: {
        'ni_bcp_no': bcpno,
        'password': password,
      },
